...
class ChartsController implements IController
{
    ...
    function getData(): array
    {
        ...
        $dataset = array("urgency" => $urgency[0], "impact" => $impact[0], "number_of_affective_machine" => $numberOfAffectiveMachine[0], "project_phase" => $projectPhase[0],
            "reproductive" => $reproductive[0], "expected_priority" => $expectedPriority[0], "priority_method_DN" => $priority1[0], "priority_method_RS" => $priority2[0], "priority_method_RR" => $priority3[0], "priority_method_RE" => $priority4[0], "priority_method_ROC" => $priority5[0]);
